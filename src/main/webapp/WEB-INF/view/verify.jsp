...
<script language="javascript">
	...
	<div class="modal">
		...
		<div class="content">
				...
				<h3>안전한 서비스 이용을 위해 QR코드를 인증해 주세요.</h3>
			...
			<fieldset class="password">
				...
				<div class="frame">
					...
					<ul class="more_info_text">
						<li><span class="blt">*</span>아래 QR코드를 찰칵V 앱으로 인식후 합니다..</li>
						<li><span class="blt">*</span>QR코드 인식 성공 후, 확인 버튼을 클릭하여 이후 프로세스가 진행 됩니다.</li>
					</ul>
