...
<script language="javascript">
	...
	<div class="modal">
		...
		<div class="content">
			...
			<a href="register?userId=${userId}&telId=${telId}">가입</a> 후 이용 해주세요.
		...
		<!-- button -->
		<div class="btn_guide">
			<button class="btnb_confirm" onclick="javascript:location.href='register?userId=${userId}&telId=${telId}'">가입</button>
		</div>
